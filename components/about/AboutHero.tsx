...
export default function AboutHero() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating particles */}
      <motion.div
        className="absolute top-[25%] left-[15%] w-1 h-1 rounded-full opacity-40"
        style={{ backgroundColor: "#d7be59" }}
        animate={{ y: [-10, 10, -10], opacity: [0.3, 0.7, 0.3] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute top-[55%] right-[20%] w-1.5 h-1.5 rounded-full opacity-30"
        style={{ backgroundColor: "#d7be59" }}
      ...
      >
        ...
        <motion.nav variants={fadeInUp} className="mb-8">
          <ol className="flex items-center gap-2 text-xs tracking-wider uppercase">
            ...
            <li style={{ color: "#d7be59" }}>About Us</li>
          </ol>
        </motion.nav>
        ...
        >
          We are Mindstorm Strategic Consulting &mdash; a team of dedicated
          education professionals helping students navigate the global academic
