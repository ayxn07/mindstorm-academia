...
export default function CareerHero() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating particles */}
      <motion.div
        className="absolute top-[28%] left-[14%] w-1 h-1 rounded-full opacity-40"
        style={{ backgroundColor: "#d7be59" }}
        animate={{ y: [-10, 10, -10], opacity: [0.3, 0.7, 0.3] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute top-[52%] right-[16%] w-1.5 h-1.5 rounded-full opacity-30"
        style={{ backgroundColor: "#d7be59" }}
      ...
      >
        ...
        <motion.nav variants={fadeInUp} className="mb-8">
          <ol className="flex items-center gap-2 text-xs tracking-wider uppercase">
            ...
            <li style={{ color: "#d7be59" }}>Career Guidance</li>
          </ol>
        </motion.nav>
        ...
        {/* Headline */}
        <motion.div variants={fadeInUp} className="mb-6 ">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.1] tracking-tight text-white text-center">
            <SplitText
              text="Navigate Your "
              tag="span"
        ...
        >
          Expert career guidance to help you discover your strengths, explore
          opportunities, and chart a clear path toward a fulfilling professional
          future.
        </motion.p>
      </motion.div>
    </section>
